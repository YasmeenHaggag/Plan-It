...
//        return filterPlacesByTown(sortedPlaces,townName);
    ...
    public List<Place> getSortedNearbyPlaces(String googleMapsUrl) {
        ...
        //return placeRepository.getSpecefiedElements(places);
        return places;
...
//        List<Place> places=placeRepository.getByTownName(townName);
//        places=filterPlacesByType(places,placeType);
//        Collections.sort(places,Comparator.comparingDouble(Place::getAvgPrice));
//        return places;
        ...
        //System.out.println(filtredPlaces);
        if(placeType != null && !placeType.isEmpty())
            filtredPlaces=filterPlacesByType(filtredPlaces,placeType);
//        List<Place> filteredPlaces=getSortedByPriceAndTown(townName);
//        filteredPlaces=filterPlacesByType(filteredPlaces,placeType);
...
//        //places.forEach(place -> places);
//        List<Place> places=placeRepository.findAll();
//        Collections.sort(places,Comparator.comparingDouble(Place::getAvgRate));
//        return places;
//    }
...
//    public List<Place> getSortedByPriceAndTown(String towName){
//
//         return places;
//    }
...
//    List<PlaceProjection> getSpecefiedElements(){
//        return placeRepository.getSpecefiedElements(getSortedNearbyPlaces());
//    }
...
//                return this.getByTownAndType(townName,placeType);
            else if (townName!=null && url!=null && placeType!=null)
