...
//    public void updatePlan(String planId,List<String> planItems){
//        if(planItems!=null){
//          Plan oldPlan=plansRepository.findById(planId).get();
//          oldPlan.setPlanItems(planItems);
//          plansRepository.save(oldPlan);
//        }
//    }
}
